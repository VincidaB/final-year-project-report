...
\label{section:big title}%label to reference section
    ...
    \subsection{Six wheeled platform setup}
        ...
        \subsubsection{Electronics architecture}
            ...
            Not including the power distribution and regulation system, Figure \ref{fig:overall_electical_system} shows the electrical connections of these components on the modified six-wheeled platform.
